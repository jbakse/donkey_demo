...
class Jumper {
  ...
  step(t) {
    ...
    // input - left/right
    const grip = this.isGrounded ? .25 : .1;
    ...
    // input - jump
    if (this.jumpButton.isDown && this.jumpButton.framesDown < 3 && this.isGrounded) {
      this.dY = -20;
    }
...
function draw() {
  ...
  cameraY = lerp(cameraY, jumper.y - 350, .1);
